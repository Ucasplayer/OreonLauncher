...
const dataPath = path.join(sysRoot, '.oreonlauncher')
...
/**
 * Adds an offline account to the database. Offline accounts are intended for
 * development servers with online-mode disabled.
 *
 * @param {string} uuid The generated offline UUID.
